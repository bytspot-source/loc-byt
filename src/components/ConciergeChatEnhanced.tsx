...
export function ConciergeChatEnhanced({ onBack, venue, userData }: ConciergeChatProps) {
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-end space-x-3">
            <Button
              variant="ghost"
              size="sm"
              className="w-11 h-11 rounded-full text-white hover:bg-white/10 transition-all duration-200 touch-target flex-shrink-0"
            >
            ...
            <div className="flex-1 relative">
              <Input
                ...
                className="bg-white/10 border-white/20 text-white placeholder-white/50 rounded-2xl pr-14 h-12 text-base resize-none transition-all duration-200 focus:bg-white/15 focus:border-[#00BFFF]/50"
                style={{
                  backdropFilter: 'blur(10px)',
              ...
              <Button
                variant="ghost"
                size="sm"
                className="absolute right-2 top-1/2 transform -translate-y-1/2 w-8 h-8 rounded-full text-white hover:bg-white/10 transition-all duration-200"
              >
            ...
            >
              <Button
                ...
                className="w-12 h-12 rounded-full bg-gradient-to-r from-[#00BFFF] to-[#FF00FF] hover:from-[#0088CC] hover:to-[#CC00CC] text-white disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 transition-all duration-200 shadow-lg"
                style={{
                  boxShadow: '0 4px 15px rgba(0, 191, 255, 0.3)',
                }}
              >
          ...
          >
            {[
              { icon: MapPin, label: 'Find spots', action: 'Show me popular venues nearby', color: 'from-green-400 to-emerald-500' },
              { icon: Car, label: 'Parking', action: 'Help me find secure parking', color: 'from-blue-400 to-cyan-500' },
              { icon: Calendar, label: 'Book', action: 'I need to make a reservation', color: 'from-purple-400 to-pink-500' },
              { icon: Star, label: 'Premium', action: 'What premium services are available?', color: 'from-yellow-400 to-orange-500' }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
              ...
              >
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 rounded-full whitespace-nowrap h-10 px-4 touch-target transition-all duration-200 flex items-center space-x-2"
                  style={{
                    backdropFilter: 'blur(10px)',
                    background: 'rgba(255, 255, 255, 0.05)',
                  }}
